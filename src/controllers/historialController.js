    ...
    try {
        ...
        historial.forEach(entry => {
            worksheet.addRow({
                ...
                fechaAsignacion: entry.fechaAsignacion ? new Date(entry.fechaAsignacion).toLocaleString() : 'N/A',
                fechaBaja: entry.fechaBaja ? new Date(entry.fechaBaja).toISOString() : 'N/A',
            });
        });
